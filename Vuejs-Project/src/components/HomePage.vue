<template>
    <h1>HOME PAGE</h1>
    <p>En esta pagina web se va a aprender sobre el sintaxis basico de Vue.js, en este caso se esta realizacion por medio de ejemplos segun cada termino, los cuales son los siguientes:</p>
    <br>
    <div>
        <br>
