<template>
    ...
    <div id="ejemplo">
        ...
        <p>expresion: <strong>{{valor1 + " + " + valor2}}</strong></p>
        <p>valor1: <strong>{{valor1}}</strong></p>
        <p>valor2: <input type="number" min="0" max="100" v-model="valortemp"></p>
        <button v-on:click="actualizarValores()">Calcular</button>
    </div>
</template>
